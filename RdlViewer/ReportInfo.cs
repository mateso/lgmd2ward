...
namespace RdlViewer
{
    ...
    class ReportInfo
    {
        ...
        public DataTable GetData(string dataSetName, ReportParameterInfoCollection reportParams, string strConnectionString)
        {
            ...
            if (dataSetInfo.dataTable == null)
            {
                ...
                if (dataSourceInfo.connection == null)
                {
                    ...
                    dataSourceInfo.connection = connection;// dialog.connection;
                ...
                if (dataSetInfo.queryParameters != null)
                {
                    foreach (QueryParameterInfo queryParameterInfo in dataSetInfo.queryParameters)
                    {
                        ...
                        if (parameterName.EndsWith("Date"))
                            command.Parameters[queryParameterInfo.parameterName].DbType = DbType.Date;
                    }
                }
